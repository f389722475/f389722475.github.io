...
const isGitHubUserSite =
	githubOwner && githubRepositoryName
...
const inferredBasePath =
	githubRepositoryName && !isGitHubUserSite
		? `/${githubRepositoryName}/`
		: "/";

// SITE_URL / BASE_PATH can override the automatic GitHub Pages values.
// Outside GitHub Actions the original local configuration remains unchanged.
